...
class VerbBook(FPDF):
    ...
    def draw_verb_page(self, day_num, verb_info):
        ...
        # We need to fill the rest of the page.
        # Total height = PAGE_H. Current Y is ~100.
        # We have ~160mm of space left. 160 / 6 = 26mm per prompt.
        # 26mm is about 3 lines of writing space per prompt. Perfect!
        ...
        for title, subtitle in prompts:
            ...
            self.ln(line_spacing * 3)

pdf = VerbBook()
pdf.draw_verb_page(1, verbs_100[0])

pdf.output("/workspace/one-verb-a-day/test_baseline_cut.pdf")

...
class Vol1Book(FPDF):
    ...
    def draw_verb_page(self, day_num, verb_info):
        ...
        # Left: DAY 1/100
        # Right: DATE
        # Center between them: The QR Code (bigger)
        # Below them: TODAY'S VERB
        
        # Y position for top row
        y_top = self.get_y()
        ...
        self.cell(40, 10, f"DAY {day_num}/100", 0, 0, 'L')
...
pdf.output("/workspace/one-verb-a-day/test_qr_book1_fixed2.pdf")
